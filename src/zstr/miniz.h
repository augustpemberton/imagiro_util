...
MINIZ_EXPORT int mz_compress(unsigned char *pDest, mz_ulong *pDest_len, unsigned char *pSource, mz_ulong source_len);
MINIZ_EXPORT int mz_compress2(unsigned char *pDest, mz_ulong *pDest_len, unsigned char *pSource, mz_ulong source_len, int level);
...
MINIZ_EXPORT int mz_uncompress(unsigned char *pDest, mz_ulong *pDest_len, unsigned char *pSource, mz_ulong source_len);
MINIZ_EXPORT int mz_uncompress2(unsigned char *pDest, mz_ulong *pDest_len, unsigned char *pSource, mz_ulong *pSource_len);
